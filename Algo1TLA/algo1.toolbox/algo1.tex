...
\fl{}\moduleLeftDash\cl{ {\MODULE} algo1}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers ,\, TLC}
\fl{ {\CONSTANTS} n}
\fl{}
\fl{}
\fl{ {\p@mmalgorithm} algo1 {\p@lbrace}}
\fl{}
\fl{ {\p@variables} i \.{=} 3 ,\, count \.{=} 2 ,\, c {\p@semicolon}}
\fl{ {\p@lbrace}}
\fl{ {\p@if} {\p@lparen}}\al{9}{2}{ n \.{\geq} 1 {\p@rparen} {\p@lbrace}}
 \fl{ {\p@print} {\langle}\@w{First\ } ,\, n ,\,\@w{\ prime\ number\ are\
 :\ensuremath{\backslash}n\ 2\ensuremath{\backslash}n} {\rangle}
 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{}
\fl{ {\p@while} {\p@lparen} count \.{\leq} n {\p@rparen} {\p@lbrace}}
\fl{ c \.{:=} 2 {\p@semicolon}}
 \fl{ {\p@while} {\p@lparen} c \.{\leq} ( i \.{-} 1 ) AND ( i \.{\%} c )
 {\bang} \.{=} 0 {\p@rparen} {\p@lbrace}}
\fl{ c \.{:=} c \.{+} 1 {\p@semicolon}}
 \fl{ {\p@if} {\p@lparen}}\al{17}{2}{ c \.{\defeq} i \.{\,\&\&\,} i \.{\%} c
 {\bang} \.{=} 0 {\p@rparen} {\p@lbrace}}
 \fl{ {\p@print} {\langle} i ,\,\@w{\ensuremath{\backslash}n} {\rangle}
 {\p@semicolon}}
\fl{ count \.{:=} count \.{+} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{}
 \fl{ i}\al{22}{1}{ \.{:=}}\al{22}{2}{ i}\al{22}{3}{ \.{+}}\al{22}{4}{
 1}\al{22}{5}{ {\p@semicolon}}
 \fl{ c}\al{23}{1}{ \.{:=}}\al{23}{2}{ c}\al{23}{3}{ \.{+}}\al{23}{4}{
 1}\al{23}{5}{ {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}%
...
\fl{}
\fl{}
\fl{ {\CONSTANT} defaultInitValue}
\fl{ {\VARIABLES} i ,\, count ,\, c ,\, pc}
\fl{}
\fl{ vars}\al{34}{1}{ \.{\defeq} {\langle} i ,\, count ,\, c ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{36}{1}{ \.{\defeq}}\al{36}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{37}{1}{ i \.{=} 3}
\fl{ \.{\land}}\al{38}{1}{ count \.{=} 2}
\fl{ \.{\land}}\al{39}{1}{ c \.{=} defaultInitValue}
\fl{ \.{\land}}\al{40}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
 \fl{ Lbl\_1}\al{42}{1}{ \.{\defeq}}\al{42}{2}{ \.{\land}}\al{42}{3}{ pc
 \.{=}\@w{Lbl\_1}}
\fl{ \.{\land}}\al{43}{1}{ {\IF}}\al{43}{2}{ n \.{\geq} 1}
 \fl{ \.{\THEN}}\al{44}{1}{ \.{\land}}\al{44}{2}{ PrintT ( {\langle}\@w{First\
 } ,\, n ,\,\@w{\ prime\ number\ are\ :\ensuremath{\backslash}n\
 2\ensuremath{\backslash}n} {\rangle} )}
\fl{ \.{\ELSE}}\al{45}{1}{ \.{\land}}\al{45}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{46}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{47}{1}{ {\UNCHANGED} {\langle} i ,\, count ,\, c {\rangle}}
\fl{}
 \fl{ Lbl\_2}\al{49}{1}{ \.{\defeq}}\al{49}{2}{ \.{\land}}\al{49}{3}{ pc
 \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{50}{1}{ {\IF}}\al{50}{2}{ count \.{\leq} n}
\fl{ \.{\THEN}}\al{51}{1}{ \.{\land}}\al{51}{2}{ c \.{'} \.{=} 2}
\fl{ \.{\land}}\al{52}{1}{ pc \.{'}}\al{52}{3}{ \.{=}}\al{52}{4}{\@w{Lbl\_3}}
 \fl{ \.{\ELSE}}\al{53}{1}{ \.{\land}}\al{53}{2}{ pc \.{'}}\al{53}{4}{
 \.{=}}\al{53}{5}{\@w{Done}}
\fl{ \.{\land}}\al{54}{1}{ c \.{'} \.{=} c}
\fl{ \.{\land}}\al{55}{1}{ {\UNCHANGED} {\langle} i ,\, count {\rangle}}
\fl{}
 \fl{ Lbl\_3}\al{57}{1}{ \.{\defeq}}\al{57}{2}{ \.{\land}}\al{57}{3}{ pc
 \.{=}\@w{Lbl\_3}}
 \fl{ \.{\land}}\al{58}{1}{ {\IF}}\al{58}{2}{ c \.{\leq} ( i \.{-} 1 )
 \.{\,\&\&\,} ( i \.{\%} c ) {\bang} \.{=} 0}
\fl{ \.{\THEN}}\al{59}{1}{ \.{\land}}\al{59}{2}{ c \.{'} \.{=} c \.{+} 1}
 \fl{ \.{\land}}\al{60}{1}{ {\IF}}\al{60}{2}{ c \.{'} \.{\defeq} i
 \.{\,\&\&\,} i \.{\%} c \.{'} {\bang} \.{=} 0}
 \fl{ \.{\THEN}}\al{61}{1}{ \.{\land}}\al{61}{2}{ PrintT ( {\langle} i
 ,\,\@w{\ensuremath{\backslash}n} {\rangle} )}
\fl{ \.{\land}}\al{62}{1}{ count \.{'} \.{=} count \.{+} 1}
\fl{ \.{\ELSE}}\al{63}{1}{ \.{\land}}\al{63}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{64}{1}{ count \.{'} \.{=} count}
\fl{ \.{\land}}\al{65}{1}{ i \.{'} \.{=} i \.{+} 1}
\fl{ \.{\land}}\al{66}{1}{ pc \.{'}}\al{66}{3}{ \.{=}}\al{66}{4}{\@w{Lbl\_4}}
 \fl{ \.{\ELSE}}\al{67}{1}{ \.{\land}}\al{67}{2}{ pc \.{'}}\al{67}{4}{
 \.{=}}\al{67}{5}{\@w{Lbl\_2}}
\fl{ \.{\land}}\al{68}{1}{ {\UNCHANGED} {\langle} i ,\, count ,\, c {\rangle}}
\fl{}
 \fl{ Lbl\_4}\al{70}{1}{ \.{\defeq}}\al{70}{2}{ \.{\land}}\al{70}{3}{
 pc}\al{70}{4}{ \.{=}}\al{70}{5}{\@w{Lbl\_4}}
\fl{ \.{\land}}\al{71}{1}{ c \.{'}}\al{71}{3}{ \.{=}}\al{71}{4}{ c \.{+} 1}
\fl{ \.{\land}}\al{72}{1}{ pc \.{'} \.{=}\@w{Lbl\_3}}
\fl{ \.{\land}}\al{73}{1}{ {\UNCHANGED} {\langle} i ,\, count {\rangle}}
\fl{}
 \fl{ Next}\al{75}{1}{ \.{\defeq}}\al{75}{2}{ Lbl\_1}\al{75}{3}{ \.{\lor}
 Lbl\_2 \.{\lor} Lbl\_3 \.{\lor} Lbl\_4}
\fl{ \.{\lor}}\al{76}{1}{%
\@y{\@s{0}%
 Disjunct to prevent deadlock on termination
}%
}
\fl{ ( pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars )}
\fl{}
